...
KC_ASDF_NAME="asdf-pipx"
KC_ASDF_REPO="https://github.com/kc-workspace/asdf-pipx"
export KC_ASDF_ORG KC_ASDF_NAME KC_ASDF_REPO

## Application information
KC_ASDF_APP_TYPE="python"
KC_ASDF_APP_NAME="pipx"
KC_ASDF_APP_WEBS="https://pypa.github.io/pipx/"
KC_ASDF_APP_DESC="Install and Run Python Applications in Isolated Environments"
KC_ASDF_APP_REPO="https://github.com/pypa/pipx"
